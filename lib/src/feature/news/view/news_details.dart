...
class NewsDetails extends StatelessWidget {
  ...
  Padding userInfoSection(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: Constants.MARGIN),
      child: SizedBox(
    ...
    return Padding(
      ...
      child: Text(
        ...
        style: context.textTheme.headline1
            ?.copyWith(fontFamily: GStyles.fontSanFrancisco, fontSize: 20.sp),
      ),
    );
  }

  SizedBox imageHeader(BuildContext context) {
    return SizedBox(
